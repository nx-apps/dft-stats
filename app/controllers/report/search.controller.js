exports.hamonize = function (req, res) {
    ...
    req.jdbc.query('mssql', 'exec sp_stats_query_hamonize @hmYear=?,@hmCode=?,@dateStart=?,@dateEnd=?',
        ...
        function (err, data) {
            ...
            res.json(data);
            res.ireport("search/hamonize.jasper", req.query.export || "pdf", data, { date_start, date_end });
...
exports.company = function (req, res) {
    ...
    req.jdbc.query('mssql', 'exec sp_stats_query_company @taxNo=?,@dateStart=?,@dateEnd=?',
        [val.taxNo, val.date_start, val.date_end],
        function (err, data) {
            data = JSON.parse(data);
            // res.json(data);
            res.ireport("search/company.jasper", req.query.export || "pdf", data, { date_start, date_end });
