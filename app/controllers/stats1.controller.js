exports.index = function (req, res, next) {
    ...
    r.expr([
        ...
        .then(function (result) {
            //res.json(result);
            res.ireport("stats1.jasper", "pdf", result, parameters);
        });
}


exports.link = function (req, res, next) {
    var html="<a href='https://localhost:4000/api/stats/stats1' target='_blank'>1.สถานการณ์ส่งออก</a><br>";
    html+="<a href='https://localhost:4000/api/stats/stats3' target='_blank'>3.การส่งออกข้าวไทยแยกตามชนิดข้าว</a><br>";
    html+="<a href='https://localhost:4000/api/stats/stats4' target='_blank'>4.ตลาดส่งออกข้าวแบ่งตามภูมิภาค</a><br>";
    html+="<a href='https://localhost:4000/api/stats/stats6' target='_blank'>6.ราคาข้าวสาร</a><br>";
    html+="<a href='https://localhost:4000/api/stats/stats7' target='_blank'>7.ราคาข้าวเปลือก</a><br>";
    html+="<a href='https://localhost:4000/api/stats/stats8' target='_blank'>8.สถานะการระบายข้าว</a><br>";
    html+="<a href='https://localhost:4000/api/stats/stats9' target='_blank'>9.ประมาณการมูลค่าข้าว</a><br>";
